...
import (
	...
	"github.com/hexdecteam/easegateway/pkg/pipelines"
	plugins_gw "github.com/hexdecteam/easegateway/pkg/plugins"
...
func NewJSONFileStore() (*JSONFileStore, error) {
	...
	pluginFullFile := filepath.Join(option.ConfigHome, pluginFile)
	pipelineFullFile := filepath.Join(option.ConfigHome, pipelineFile)
