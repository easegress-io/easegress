...
func (e *ObjectEntity) InitWithRecovery(muxMapper protocols.MuxMapper) {
	defer func() {
...
func (e *ObjectEntity) InheritWithRecovery(previousEntity *ObjectEntity, muxMapper protocols.MuxMapper) {
	defer func() {
		if err := recover(); err != nil {
