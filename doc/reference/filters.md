...
| stickyExpire  | string | When `sticky` is `true` and `stickyCookie` is not set, this option is used to set expire time of cookie generated by load balancer, default is 2h | No       |
