...
```bash
egctl create object -f order-service.yaml
```
...
```bash
egctl create object -f ecommerce-server.yaml
```
...
```bash
egctl apply object -f order-service.yaml
```
...
```bash
egctl create object -f notify-service.yaml
```
