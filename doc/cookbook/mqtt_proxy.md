...
> Note: `"gateway/gate123/iphone/log"` index 0 is `"gateway"`, `"/gateway/gate123/iphone/log"` index 0 is still `"gateway"` not `""`. So, index 0 is first non-empty level of multi-level MQTT topic.
