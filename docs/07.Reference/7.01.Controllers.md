...
- [Common Types](#common-types)
  ...
  - [AIGatewayController.QdrantSpec](#aigatewaycontrollerqdrantspec)
...
See more details about `Retry`, `CircuitBreaker`, or other resilience policies in [the Resilience Policy documentation](../02.Tutorials/2.4.Resilience.md).
...
### AIGatewayController.EmbeddingSpec
...
| qdrant         | [QdrantSpec](#aigatewaycontrollerqdrantspec)     | Qdrant-specific configuration            | No       |
...
### AIGatewayController.QdrantSpec

| Name   | Type   | Description             | Required |
| ------ | ------ | ----------------------- | -------- |
| host   | string | Qdrant server host      | Yes      |
| port   | int    | Qdrant gRPC port        | Yes      |
| apiKey | string | Qdrant API key          | No       |
| useTLS | bool   | Enable TLS              | No       |
